...
<?php
 $maincssv=100;
  $title="Vocabulary By IELTS (Activity)"; 
  $userid=$_GET['ID'];
 ?>
<head>
...
echo "<center>";
  echo "Activity: ".str_replace("'","",$cfg_cefr_dictationType_user)."<br>"; 
    ...
    $sql="  
            ...
            where qv.type in ($cfg_cefr_dictationType_user) and a=front   and userid=users.id and conv.cefr=flashcards_cefr_v.cefr and 
            userid=$userid
