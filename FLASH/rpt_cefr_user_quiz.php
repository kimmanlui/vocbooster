   ...
   // echo "在学: Numbr of Words Being Learned<br>";
    ...
    class TableRows extends RecursiveIteratorIterator { 
        ...
        function current() {
        	    ...
        	    {
          	      $retV = "<td><a href='g_IELTS_quiz.php?ID=$this->curID'>" . parent::current(). "</a></td>";
        	    }
    ...
    try {
        ...
        $tableCols = array();
            ...
            from quizlog_v_student qv ,  flashcards_cefr_v, users, conv
            where qv.type in ('q') and a=front   and userid=users.id and conv.cefr=flashcards_cefr_v.cefr
