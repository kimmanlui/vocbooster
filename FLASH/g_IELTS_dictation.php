...
<?php
 $maincssv=100;
  $title="Vocabulary By IELTS (Activity Type)"; 
  $userid=$_GET['ID'];
 ?>
<head>
...
echo "<center>";
  echo "Activity Type: ".str_replace("'","",$cfg_cefr_dictationType)."<br>"; 
    ...
    $sql="  
            ...
            where qv.type in ($cfg_cefr_dictationType) and a=front   and userid=users.id and conv.cefr=flashcards_cefr_v.cefr and 
            userid=$userid
