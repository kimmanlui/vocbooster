...
<?php
 $title_user="Word Proficiency Report (Flashcard Only)"; 
 $usedView_user="v_student_performance";
 $callingphp_user="rpt_learnword_user_detail.php";
 $maincssv=100;
?>
...
sum( if (learning<$learningThreshold, 1, 0)) LNG from $usedView_user , users 
