...
cefr, 
audiob64,
cardid from general_flashcards
where (coalesce(front, '') like :_search )
order by enable desc, cardid
";
...
// optional, define editable input controls on the grid dictionary
//$lm->grid_input_control['is_active'] = '--checkbox';
$lm->form_input_control['dictionary'] = "select '', 'RESET EMPTY'  ; --radio";
$lm->form_input_control['cefr'] = "select '', 'RESET EMPTY.'  ; --radio";
$lm->form_input_control['audiob64'] = "select '', 'RESET EMPTY'  ; --radio";
$lm->form_input_control['enable'] = "select '1', 'Active.' union select '0', 'Inactive.'  ; --radio";
