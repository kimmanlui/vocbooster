...
class lazy_mofo{
    ...
    public $grid_limit = 100;               // pagination limit number of records per page
    ...
    public $grid_ellipse_at = 60;           // limit number of characters displayed, set to 0 to disable truncation
  ...
  public $grid_export_link = "";
    ...
    // output date formats
    public $date_out = 'Y-m-d';                 // output date, change to d/m/Y for non-us
    public $datetime_out = 'Y-m-d h:i A';       // output datetime, change to d/m/Y h:i A for non-us
