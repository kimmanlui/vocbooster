...
$username=$_SESSION['name']; 
    ...
    try {
      ...
      //$conditionV="(67, 68, 70, 74, 86)";
        ...
        $sql = "
            select deckid, q, ans, R1, R2, R3, R4, R5 from quiz_v
              order by rand() limit $numQuizQuestion
            ";
...
echo "<br>";
echo "Quiz: Select the correct answer";
echo "<div id=fo>";
echo "<form method='post' action='quizData.php' >";
