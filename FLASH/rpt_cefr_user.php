...
<?php
 $maincssv=100;
 $title="CEFR/IELTS Report (FlashCard Only)"; 
 ?>
<head>
   ...
   // echo "在学: Numbr of Words Being Learned<br>";
    ...
    class TableRows extends RecursiveIteratorIterator { 
        ...
        function current() {
        	    ...
        	    {
          	      $retV = "<td><a href='g_IELTS.php?ID=$this->curID'>" . parent::current(). "</a></td>";
        	    }
    ...
    try {
        ...
        $tableCols = array();
            ...
            where word=front   and userid=users.id and conv.cefr=flashcards_cefr_v.cefr
