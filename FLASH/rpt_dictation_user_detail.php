...
// $usedView_detail="v_dictation_performance_wk";
 $callingphp_detail="rpt_dictation_user_word.php";
 $maincssv=100;
...
//                   ";    
            ...
            $sql = "
select   em.wk, 
sum( if (em.learning=1, 1, 0)) learned , 
sum( if (em.learning!=1 and em.learning>=$learningThreshold, 1, 0)) Newly_learned , 
sum( if (em.learning<$learningThreshold, 1, 0)) learning from 
(
 ...
 from all_log_v_student where type in ($cfg_dictationType) group by userid, word, wk
) em, users u
where em.userid=u.id and em.userid='$id' group by wk order by wk 
                   ";                       
